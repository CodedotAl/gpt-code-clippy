...
def main():
    ...
    text_column_name = "whole_func_string"  #  if "text" in column_names else column_names[0]
        ...
        for step in tqdm(range(steps_per_epoch), desc="Training...", position=1, leave=False):
            ...
            if cur_step % training_args.logging_steps == 0 and cur_step > 0:
                ...
                if has_wandb and jax.process_index() == 0 and ("wandb" in training_args.report_to):
                    ...
                    _metrics = {
                        k if k == "learning_rate" else f"train_{k}": mb_item(v.mean()) for k, v in train_metric.items()
                    }
